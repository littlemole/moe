...
CFLAG=-DL_ENDIAN -DDSO_WIN32 -fomit-frame-pointer -O3 -mcpu=i486 -Wall -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_KRB5    
APP_CFLAG=
LIB_CFLAG=
SHLIB_CFLAG=
APP_EX_OBJ=
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.o \
	...
	$(OBJ_D)\cversion.o $(OBJ_D)\ex_data.o $(OBJ_D)\tmdiff.o \
	$(OBJ_D)\cpt_err.o $(OBJ_D)\ebcdic.o $(OBJ_D)\uid.o \
	$(OBJ_D)\o_time.o $(OBJ_D)\o_str.o $(OBJ_D)\o_dir.o \
	$(OBJ_D)\md2_dgst.o $(OBJ_D)\md2_one.o $(OBJ_D)\md4_dgst.o \
	$(OBJ_D)\md4_one.o $(OBJ_D)\md5_dgst.o $(OBJ_D)\md5_one.o \
	...
	$(OBJ_D)\rc2ofb64.o $(OBJ_D)\rc4_skey.o $(OBJ_D)\rc4_enc.o \
	...
	$(OBJ_D)\aes_ofb.o $(OBJ_D)\aes_ctr.o $(OBJ_D)\aes_core.o \
	$(OBJ_D)\aes_cbc.o $(OBJ_D)\bn_add.o $(OBJ_D)\bn_div.o \
	$(OBJ_D)\bn_exp.o $(OBJ_D)\bn_lib.o $(OBJ_D)\bn_ctx.o \
	$(OBJ_D)\bn_mul.o $(OBJ_D)\bn_mod.o $(OBJ_D)\bn_print.o \
	$(OBJ_D)\bn_rand.o $(OBJ_D)\bn_shift.o $(OBJ_D)\bn_word.o \
	$(OBJ_D)\bn_blind.o $(OBJ_D)\bn_kron.o $(OBJ_D)\bn_sqrt.o \
	$(OBJ_D)\bn_gcd.o $(OBJ_D)\bn_prime.o $(OBJ_D)\bn_err.o \
	$(OBJ_D)\bn_sqr.o $(OBJ_D)\bn_asm.o $(OBJ_D)\bn_recp.o \
	$(OBJ_D)\bn_mont.o $(OBJ_D)\bn_mpi.o $(OBJ_D)\bn_exp2.o \
	$(OBJ_D)\bn_gf2m.o $(OBJ_D)\bn_nist.o $(OBJ_D)\bn_depr.o \
	...
	$(OBJ_D)\nsseq.o $(OBJ_D)\d2i_pu.o $(OBJ_D)\d2i_pr.o \
	$(OBJ_D)\i2d_pu.o $(OBJ_D)\i2d_pr.o $(OBJ_D)\t_req.o \
	$(OBJ_D)\t_x509.o $(OBJ_D)\t_x509a.o $(OBJ_D)\t_crl.o \
	$(OBJ_D)\t_pkey.o $(OBJ_D)\t_spki.o $(OBJ_D)\t_bitst.o \
	$(OBJ_D)\tasn_new.o $(OBJ_D)\tasn_fre.o $(OBJ_D)\tasn_enc.o \
	$(OBJ_D)\tasn_dec.o $(OBJ_D)\tasn_utl.o $(OBJ_D)\tasn_typ.o \
	$(OBJ_D)\f_int.o $(OBJ_D)\f_string.o $(OBJ_D)\n_pkey.o \
	$(OBJ_D)\f_enum.o $(OBJ_D)\a_hdr.o $(OBJ_D)\x_pkey.o \
	$(OBJ_D)\a_bool.o $(OBJ_D)\x_exten.o $(OBJ_D)\asn1_gen.o \
	$(OBJ_D)\asn1_par.o $(OBJ_D)\asn1_lib.o $(OBJ_D)\asn1_err.o \
	$(OBJ_D)\a_meth.o $(OBJ_D)\a_bytes.o $(OBJ_D)\a_strnid.o \
	$(OBJ_D)\evp_asn1.o $(OBJ_D)\asn_pack.o $(OBJ_D)\p5_pbe.o \
	$(OBJ_D)\p5_pbev2.o $(OBJ_D)\p8_pkey.o $(OBJ_D)\asn_moid.o \
	$(OBJ_D)\pem_sign.o $(OBJ_D)\pem_seal.o $(OBJ_D)\pem_info.o \
	$(OBJ_D)\pem_lib.o $(OBJ_D)\pem_all.o $(OBJ_D)\pem_err.o \
	$(OBJ_D)\pem_x509.o $(OBJ_D)\pem_xaux.o $(OBJ_D)\pem_oth.o \
	$(OBJ_D)\pem_pk8.o $(OBJ_D)\pem_pkey.o $(OBJ_D)\x509_def.o \
	$(OBJ_D)\x509_d2.o $(OBJ_D)\x509_r2x.o $(OBJ_D)\x509_cmp.o \
	$(OBJ_D)\x509_obj.o $(OBJ_D)\x509_req.o $(OBJ_D)\x509spki.o \
	$(OBJ_D)\x509_vfy.o $(OBJ_D)\x509_set.o $(OBJ_D)\x509cset.o \
	$(OBJ_D)\x509rset.o $(OBJ_D)\x509_err.o $(OBJ_D)\x509name.o \
	$(OBJ_D)\x509_v3.o $(OBJ_D)\x509_ext.o $(OBJ_D)\x509_att.o \
	$(OBJ_D)\x509type.o $(OBJ_D)\x509_lu.o $(OBJ_D)\x_all.o \
	$(OBJ_D)\x509_txt.o $(OBJ_D)\x509_trs.o $(OBJ_D)\by_file.o \
	$(OBJ_D)\by_dir.o $(OBJ_D)\x509_vpm.o $(OBJ_D)\v3_bcons.o \
	$(OBJ_D)\v3_bitst.o $(OBJ_D)\v3_conf.o $(OBJ_D)\v3_extku.o \
	$(OBJ_D)\v3_ia5.o $(OBJ_D)\v3_lib.o $(OBJ_D)\v3_prn.o \
	$(OBJ_D)\v3_utl.o $(OBJ_D)\v3err.o $(OBJ_D)\v3_genn.o \
	$(OBJ_D)\v3_alt.o $(OBJ_D)\v3_skey.o $(OBJ_D)\v3_akey.o \
	$(OBJ_D)\v3_pku.o $(OBJ_D)\v3_int.o $(OBJ_D)\v3_enum.o \
	$(OBJ_D)\v3_sxnet.o $(OBJ_D)\v3_cpols.o $(OBJ_D)\v3_crld.o \
	$(OBJ_D)\v3_purp.o $(OBJ_D)\v3_info.o $(OBJ_D)\v3_ocsp.o \
	$(OBJ_D)\v3_akeya.o $(OBJ_D)\v3_pmaps.o $(OBJ_D)\v3_pcons.o \
	$(OBJ_D)\v3_ncons.o $(OBJ_D)\v3_pcia.o $(OBJ_D)\v3_pci.o \
	$(OBJ_D)\pcy_cache.o $(OBJ_D)\pcy_node.o $(OBJ_D)\pcy_data.o \
	$(OBJ_D)\pcy_map.o $(OBJ_D)\pcy_tree.o $(OBJ_D)\pcy_lib.o \
	$(OBJ_D)\conf_err.o $(OBJ_D)\conf_lib.o $(OBJ_D)\conf_api.o \
	$(OBJ_D)\conf_def.o $(OBJ_D)\conf_mod.o $(OBJ_D)\conf_mall.o \
	$(OBJ_D)\conf_sap.o $(OBJ_D)\txt_db.o $(OBJ_D)\pk7_asn1.o \
	...
	$(OBJ_D)\eng_all.o $(OBJ_D)\tb_rsa.o $(OBJ_D)\tb_dsa.o \
	$(OBJ_D)\tb_ecdsa.o $(OBJ_D)\tb_dh.o $(OBJ_D)\tb_ecdh.o \
	$(OBJ_D)\tb_rand.o $(OBJ_D)\tb_store.o $(OBJ_D)\tb_cipher.o \
	$(OBJ_D)\tb_digest.o $(OBJ_D)\eng_openssl.o $(OBJ_D)\eng_cnf.o \
	...
	$(OBJ_D)\e_sureware.o $(OBJ_D)\e_ubsec.o
