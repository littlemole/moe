...
extern "C" void load_codegen_metadata()
{
  ...
  UI().addMenu(IDM_CONTEXT_TREE);    
    ...
    UI().addMenuSeparator(IDM_CONTEXT_TREE,IDM_TREE);
        ...
        UI().addMenuItem(IDM_CONTEXT_TREE, IDM_TREE, IDM_TREE_DELETE, IDB_TOOLBAR, IDM_TREE_DELETE, false, true);
    UI().addMenuSeparator(IDM_CONTEXT_TREE,IDM_TREE);
    ...
    UI().addMenuSeparator(IDM_CONTEXT_TREE,IDM_TREE);
        UI().addMenuItem(IDM_CONTEXT_TREE, IDM_TREE, IDM_TREE_PROPERTIES, IDB_TOOLBAR, IDM_TREE_PROPERTIES, false, true);
        UI().addMenuItem(IDM_CONTEXT_TREE, IDM_TREE, IDM_TREE_EXECUTE, IDB_TOOLBAR, IDM_TREE_EXECUTE, false, true);
        UI().addMenuItem(IDM_CONTEXT_TREE, IDM_TREE, IDM_TREE_NEWDIR, IDB_TOOLBAR, IDM_TREE_NEWDIR, false, true);
