...
public interface Shapes extends mol.office._IMsoDispObj,Iterable<Com4jObject> {
    @VTID(9)
    ...
    @VTID(27)
    mol.office.Shape _default();

    @VTID(28)
    mol.office.Shape addDiagram(
    ...
    @VTID(30)
    mol.office.Shape addChart(
        mol.office.XlChartType type,
        float left,
        float top,
        float width,
        float height);
