...
HRESULT __stdcall SciAxSelection::Search( BSTR what, long flags, VARIANT_BOOL* vbFound)
{ 
...
HRESULT __stdcall SciAxSelection::Replace( BSTR what, BSTR with, long flags, VARIANT_BOOL* vbReplaced)
{ 
